"""
Test the v3 optimized model performance on public cases
"""
...
for i, case in enumerate(data):
    ...
    predicted = calculate_reimbursement_v3(trip_days, miles, receipts)
...
print("=" * 80)
print("V3 OPTIMIZED MODEL PERFORMANCE EVALUATION")
print("=" * 80)
...
# Save results
df_results.to_csv(DATA_DIR / 'predictions' / 'public_cases_predictions_v3.csv', index=False)
print(f"\nPredictions saved to: {DATA_DIR / 'predictions' / 'public_cases_predictions_v3.csv'}")
...
print("=" * 40)
print(f"  V2 MAE: $161.21")
print(f"  V3 MAE: ${mae:.2f}")
print(f"  Improvement: ${161.21 - mae:.2f} ({(161.21 - mae)/161.21*100:.1f}%)") 